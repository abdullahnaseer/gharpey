@extends('admin.layouts.dashboard', ['page_title' => "Product Categories"])
...
@push('modals')
    @include('admin.products.categories.modals.create')
    @include('admin.products.categories.modals.edit')
    @include('admin.products.categories.modals.delete')
@endpush
...
@push('scripts')
    <script>
        $('#deleteModal').on('show.bs.modal', function (event) {
            ...
            var modal = $(this);
            modal.find('.modal-footer form').attr('action', "{{url('admin/products/categories')}}/" + id );
        });
        ...
        $('#editModal').on('show.bs.modal', function (event) {
            ...
            // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
            var modal = $(this);
            modal.find('form').attr('action', "{{url('admin/products/categories')}}/" + id );
