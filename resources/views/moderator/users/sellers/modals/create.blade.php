    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createModalLabel">Create Seller</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            {{ Form::open(['route' => 'moderator.users.sellers.store', 'method' => 'POST', 'class' => 't-form kt-form--fit kt-form--label-right']) }}
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12">
                        <select class="form-control kt-select2" id="warehouse_location_select2_create"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12">
                        <select class="form-control kt-select2" id="business_location_select2_create"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12">
                        <select class="form-control kt-select2" id="return_location_select2_create"
