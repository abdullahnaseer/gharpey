...
class ProfileController extends Controller
{
    ...
    {
        return view('moderator.profile.overview');
    }

    public function change_password()
    {
        return view('moderator.profile.change-password');
    }

    public function email_settings()
    {
        return view('moderator.profile.email-settings');
    }

    public function personal()
    {
        return view('moderator.profile.personal-info', [
    ...
    public function update(Request $request)
    {
        ...
        if (strpos($uri[0], 'personal') == true) {
            ...
            if($request->hasFile('profile_avatar'))
                $fields['avatar'] = $request->file('profile_avatar')->store('public/moderators');
