    ...
    <div class="kt-portlet__body">
        <div class="row">
            <div class="form-group col-sm-6 row">
                ...
                <div class="col-md-9">
                    <input type="text" name="choice_text[{{($question_index ?? '').']['.($choice_index ?? '')}}]"
                           class="form-control choice_text" required value="{{$choice_text ?? ''}}"/>
                </div>
            </div>
            <div class="form-group col-sm-6 row">
                ...
                <div class="col-md-9">
                    <input type="number"
                           name="choice_price_effect[{{ ($question_index ?? '').']['.($choice_index ?? '')}}]"
                           class="form-control choice_price_effect" required value="{{$choice_price_effect ?? 0}}"/>
