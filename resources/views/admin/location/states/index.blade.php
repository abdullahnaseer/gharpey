@extends('admin.layouts.app', ['page_title' => "States of " . $country->name, "back_url" => route('admin.location.countries.index')])
    ...
    <table class="table table-bordered dt-responsive nowrap">
        ...
        @foreach($records as $record)
            <tr>
                ...
                <td>{{$record->name}}</td>
                <td>
                    <a href="{{route('admin.location.countries.states.cities.index', [$country->id, $record->id])}}" class="btn btn-primary">
                        Cities
                    </a>
...
@push('modals')
    @include('admin.location.states.modals.create', ['country' => $country])
    @include('admin.location.states.modals.edit', ['country' => $country])
    @include('admin.location.states.modals.delete', ['country' => $country])
@endpush
