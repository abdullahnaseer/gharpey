@extends('admin.layouts.dashboard', ['page_title' => "Cities of " . $state->name . ", " . $country->name, "back_url" => route('admin.location.countries.states.index', [$country->id])])
...
@section('breadcrumb')
    ...
    <span class="kt-subheader__breadcrumbs-separator"></span>
    <span class="kt-subheader__breadcrumbs-link active">Cities</span>
@endsection
...
@push('modals')
    @include('admin.location.cities.modals.create')
    @include('admin.location.cities.modals.edit')
    @include('admin.location.cities.modals.delete')
@endpush
            ...
            var jsonResource = function () {
                var datatable = $('.kt-datatable').KTDatatable({
                    ...
                    data: {
                        ...
                        source: {
                            read: {
                                url: '{{route('admin.location.countries.states.cities.json', [$country->id, $state->id])}}',
                                method: 'POST',
                                headers: {
                    ...
                    columns: [
                        {
                            ...
                            template: function(row) {
                                return '\
						<a href="/admin/location/countries/{{$country->id}}/states/{{$state->id}}/cities/'+row.id+'/areas" class="btn btn-sm btn-clean">\
                            Areas\
                        </a>\
