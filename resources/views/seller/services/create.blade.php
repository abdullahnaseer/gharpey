...
@section('breadcrumb-elements')
    <a class="btn btn-brand btn-elevate btn-icon-sm"  href="{{route('seller.services.index')}}" data-toggle="modal" data-target="#createModal">
    ...
    <script type="text/javascript">
        function fixInputsIndexes()
        {
            $('#question_portlets > .kt-portlet').each(function( index ) {
                ...
                $(this).find('.input-price-effect-yes').attr('name', 'price_effect_yes['+index+']');
                $(this).find('.input-price-effect-no').attr('name', 'price_effect_no['+index+']');
            });
        ...
        jQuery(document).ready(function() {
            ...
            $('#question_portlets').on('change', 'select.type', function () {
                ...
                if (this.value === 'select' || this.value === 'select.single' || this.value === 'select.multiple')
                    showQuestionDetailSection(this, '.choices-container');
                else if (this.value === 'boolean')
                    showQuestionDetailSection(this, '.boolean-price-effect');
            });
