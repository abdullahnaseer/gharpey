@extends('admin.layouts.dashboard', ['page_title' => "Moderators"])

@section('breadcrumb')
    <a href="{{ route('admin.dashboard') }}" class="kt-subheader__breadcrumbs-link">Dashboard</a>
    <span class="kt-subheader__breadcrumbs-separator"></span>
    <span class="kt-subheader__breadcrumbs-link active">Moderators</span>
@endsection
...
@push('modals')
    @include('admin.users.moderators.modals.create')
    @include('admin.users.moderators.modals.edit')
    @include('admin.users.moderators.modals.delete')
@endpush
...
@push('scripts')
    <script>
        $('#deleteModal').on('show.bs.modal', function (event) {
            ...
            var modal = $(this);
            modal.find('.modal-footer form').attr('action', "{{url('admin/users/moderators')}}/" + id);
        });
        ...
        $('#editModal').on('show.bs.modal', function (event) {
            ...
            // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
            var modal = $(this);
            modal.find('form').attr('action', "{{url('admin/users/moderators')}}/" + id);
            ...
            var jsonResource = function () {
                var datatable = $('.kt-datatable').KTDatatable({
                    ...
                    data: {
                        ...
                        source: {
                            read: {
                                url: '{{route('admin.users.moderators.json')}}',
                                method: 'POST',
                                headers: {
