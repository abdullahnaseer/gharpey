@extends('admin.layouts.dashboard', ['page_title' => "Product Tags"])

@section('breadcrumb')
    <a href="{{ route('admin.dashboard') }}" class="kt-subheader__breadcrumbs-link">Dashboard</a>
    <span class="kt-subheader__breadcrumbs-separator"></span>
    <span class="kt-subheader__breadcrumbs-link active">Product Tags</span>
@endsection
...
@push('modals')
    @include('admin.products.tags.modals.create')
    @include('admin.products.tags.modals.edit')
    @include('admin.products.tags.modals.delete')
@endpush
...
@push('scripts')
    <script>
        $('#deleteModal').on('show.bs.modal', function (event) {
            ...
            var modal = $(this);
            modal.find('.modal-footer form').attr('action', "{{url('admin/products/tags')}}/" + id);
        });
        ...
        $('#editModal').on('show.bs.modal', function (event) {
            ...
            // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
            var modal = $(this);
            modal.find('form').attr('action', "{{url('admin/products/tags')}}/" + id);
            ...
            var jsonResource = function () {
                var datatable = $('.kt-datatable').KTDatatable({
                    ...
                    data: {
                        ...
                        source: {
                            read: {
                                url: '{{route('admin.products.tags.json')}}',
                                method: 'POST',
                                headers: {
